...
from ..models.user_session import UploadStatus, UserSession
...
class SessionService:
    ...
    def create_session(
        self, user_id: int, upload_filename: str, original_filename: str, file_size: int
    ) -> UserSession:
    ...
    def update_session_counts(
        self, session_id: str, total_rows: int, valid_rows: int
    ) -> bool:
    ...
    def get_user_sessions(
        ...
        user_id: int,
        limit: int = 50,
        status_filter: UploadStatus | None = None,
    ) -> list[UserSession]:
